...
for (i in 1999:2019){
  ...
  if (i<=2004){
    ...
    if (i<=2002){
      crimerate <- crimerate[-c(1:3,11,15)]#2001-2002
    }else{
      crimerate <- crimerate[c(2:11)]#2003-2004
    }
  }else if(i>=2013 & i<=2016){
    crimerate = crime[which(crime[,3]=='Rate per 100,000 inhabitants'),c(4:6,8:14)]#2013-2016
  }else{
    crimerate = crime[which(crime[,3]=='Rate per 100,000 inhabitants'),c(4:13)]#2005-2012,2017-2019
  }
  if (i<=2002){
...
library(dplyr)
#change order of columns of c9902
